    ...
    */
    ...
    'attributes' => [
        'ar' => [
            ...
            'who' => 'who are we in arabic',
            'history' => 'history in arabic',
            'massage' => 'massage in arabic',
            'goals' => 'goals in arabic',
            'vision' => 'vision in arabic',
            'ambition' => 'ambition in arabic',
            'location' => 'location in arabic',
            'value' => 'value in arabic',
            'name' => 'name in arabic',
            'company' => 'company in arabic',
            'position' => 'position in arabic',
            'talk' => 'talk in arabic',
            'first_name' => 'first name in arabic',
            'last_name' => 'last name in arabic',
            'about' => 'about in arabic',
            'services' => 'services in arabic',
            'introduction' => 'introduction in arabic',
            'content_table' => 'content table in arabic',
            'first_paragraph' => 'first paragraph table in arabic',
            'main_title' => 'main title in arabic',
            'index_name' => 'index name in arabic',
            'caption' => 'caption in arabic',
            'question' => 'question in arabic',
            'answer' => 'answer in arabic',
            'author_name' => 'author name in arabic',
            'author_title' => 'author title in arabic',
            'author_image' => 'author image in arabic',
        ],
        'en' => [
            'title' => 'title in english',
            'description' => 'description in english',
            'brief' => 'brief in english',
            'who' => 'who are we in english',
            'history' => 'history in english',
            'massage' => 'massage in english',
            'goals' => 'goals in english',
            'vision' => 'vision in english',
            'ambition' => 'ambition in english',
            ...
            'services' => 'services in english',
            'introduction' => 'introduction in english',
            'content_table' => 'content table in english',
            'first_paragraph' => 'first paragraph in english',
            'main_title' => 'main title in english',
            'index_name' => 'index name in english',
            'caption' => 'caption in english',
            'question' => 'question in english',
            'answer' => 'answer in english',
            'author_name' => 'author name in english',
            'author_title' => 'author title in english',
            'author_image' => 'author image in english',
        ],
        'slug' => 'link',
    ],
